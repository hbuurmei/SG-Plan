...
if __name__ == "__main__":
    ...
    print(f"Time ratio stdev = {np.std(time_ratios_in)}")
    print(f"Cost ratio stdev = {np.std(hier_costs_in / optimal_costs_in)}")
    print()
    ...
    print(f"Time ratio stdev = {np.std(time_ratios_cross)}")
    print(f"Cost ratio stdev = {np.std(hier_costs_cross / optimal_costs_cross)}")
    print()
